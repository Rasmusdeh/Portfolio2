...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        // bubble sort af listen med containerAmount
        for (int i = 0; i < n; i++) {
        ...
        nameArray.add(portArray.indexOf(DarEsSalaam.containerAmount()), TanjungPelepas.havn);
        nameArray.add(portArray.indexOf(TanjungPelepas.containerAmount()), TanjungPelepas.havn);


        System.out.println("List after sorting first time: ");
        System.out.println(portArray);
        int i = 0;
        int j = portArray.size() - 1;
        int price = 0;

        //while løkke som checker på havn og deres containerAmount
        //kører så længe at i<j, så vi checker listens værdier på begge sider af arrayet
        while (i < j) {
